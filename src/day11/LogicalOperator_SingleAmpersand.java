...
public class LogicalOperator_SingleAmpersand {
    ...
    public static void main(String[] args) {
        ...
        // ----> use like if you have multiple condition for rocket launching
        ...
        // isEngineRunning & isCommunicatingSystemWorking & isAirEnough
        // if isEngineRunning is false
        // it still check isComminicatingSystemWorking
        // it still check isAirEnough
        // and it eventually gives you the outcome
