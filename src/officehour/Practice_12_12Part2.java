...
public class Practice_12_12Part2 {
    ...
    public static void main(String[] args) {
        ...
        for (int j = 0; j < numbers.length; j++) {
            ...
            int count = 0;//find out the number of occurance
            for (int i = 0; i < numbers.length; i++) {
                if (numbers[i] == numbers[j]) {
                    count++;//adds one to the occerance
                }
            }
        ...
        String[] array = {"A", "A", "B", "C", "C", "D", "E"};//expected result: BDE
