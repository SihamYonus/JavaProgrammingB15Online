...
public class ReversingAString {
    ...
    public static void main(String[] args) {
        ...
        // Aknar has 5 character
        // 01234 and last character index is 5 not 5  5-1=4

        int characterCount = name.length();
        // counting character start with one
        // counting index (location) starts with 0
        // so last character index/location will be always on eless than actual character count
