...
public class InfexOfWith2Parameters {
    ...
    public static void main(String[] args) {
        ...
        // How do i start from the location that get pasr first Java
        ...
        // or you can start after you finish writing the word you are searching, for the word java + 4
        // if we do not know the lenght of the word -->> + word.length()
        int startingPointToSearchSecondJava = firstJavaLocation + 1 ; // or you can start here
        ...
        // How to know what the second word is
        // the word is in between first space and second space is second word
